  ...
  - question: What are the advantages of React JS?
    ...
    answers:
      ...
      - >-
        ...
        for manitaining larger apps
      - >-
        React components have lifecycle events that fall into State/Property
        Updates
      - >-
        React can be used with any other framework (Backbone.js, Angular.js) as
